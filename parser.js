...
const requiredStyles = [
    {
        ...
        properties: [
            ...
            { key: 'height', value: '150px' },
            { key: 'background-color', value: 'lightyellow' },
            { key: 'box-shadow', value: '10px' },
            { key: 'text-align', value: 'center' },
            { key: 'padding-top', value: '50px' }
        ]
    }
];

const cssTestCase = {
    testCaseName: 'CSS box Styles Test',
    testCaseType: 'boundary',
...
const requiredStyles2 = [
    {
        selector: 'text',
        properties: [
            { key: 'text-shadow', value: '2px 2px' }
        ]
    }
];

const cssTestCase2 = {
    testCaseName: 'CSS text Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
